...
export default function Home(){
    ...
    <Container flex="true">
        ...
        <Col xs={6} flex="true">
            ...
            <h1 style = {{margin: '10%', justifyContent: 'center'}}>New Album<br></br>April 2022</h1>
        </Col>
        <Col xs={3} flex="true">
                <img src='images/Cheetah.png' alt="Cheetah" style={{width: '100%'}} className="img-fluid pr-3" />
        </Col>
        </Row>
        <Row className="justify-content-center m-5" flex="true">
            <Col xs={12}>
        <h1 style = {{ textAlign: "center"}}>On Tour With Pavement In 2022</h1>
        <h2 style = {{textAlign: "center"}}><a style = {{textDecoration: "inherit"}} href = "tour">Get Your Tix Here</a></h2>
        </Col>
        </Row>
    </Container>
    )
