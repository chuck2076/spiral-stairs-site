...
export default function Home(){
    ...
    <Container flex="true">
        <Row>
        <a className="justify-content-center" flex="true" href="https://spiralstairspsoi.bandcamp.com/">
        <h3 className="cliptwo mt-5">New Album</h3><h1 className="clip">Medley Attack!!!</h1><h3 className="cliptwo">July 08 2022</h3>
        </a>
        </Row>
        ...
        <Col xs={6} flex="true" style={{display: "grid", textAlign: "center", color: "white", position: "relative" }}>
            ...
            <div className="imagetext">Pre-Order Now</div>
            </a>
        </Col>
        <Col xs={3} flex="true">
